/**
 * Test file for Job: precipitationsradar
 */

var assert = require ('assert');
var precipitationsradar_SUT = require('../precipitationsradar');

var mockedConfig, mockedDependencies;

describe ('precipitationsradar test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      precipitationsradar_SUT.onRun(config, mockedDependencies, function(err, data){
