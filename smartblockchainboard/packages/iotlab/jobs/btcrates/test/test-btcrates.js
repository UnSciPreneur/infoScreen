/**
 * Test file for Job: btcrates
 */

var assert = require ('assert');
var btcrates_SUT = require('../btcrates');

var mockedConfig, mockedDependencies;

describe ('btcrates test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      btcrates_SUT.onRun(config, mockedDependencies, function(err, data){
