/**
 * Test file for Job: lightswitch
 */

var assert = require ('assert');
var lightswitch_SUT = require('../lightswitch');

var mockedConfig, mockedDependencies;

describe ('lightswitch test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      lightswitch_SUT.onRun(config, mockedDependencies, function(err, data){
