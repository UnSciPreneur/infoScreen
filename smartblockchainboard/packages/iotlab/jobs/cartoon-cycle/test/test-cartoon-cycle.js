/**
 * Test file for Job: cartoon-cycle
 */

var assert = require ('assert');
var cartoon_cycleSUT = require('../widgets/cartoon-cycle');

var mockedConfig, mockedDependencies;

describe ('cartoon-cycle test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      cartoon_cycleSUT(config, mockedDependencies, function(err, data){
