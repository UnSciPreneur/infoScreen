/**
 * Test file for Job: artgallery
 */

var assert = require ('assert');
var artgallery_SUT = require('../artgallery');

var mockedConfig, mockedDependencies;

describe ('artgallery test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      artgallery_SUT.onRun(config, mockedDependencies, function(err, data){
